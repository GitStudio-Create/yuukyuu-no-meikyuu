...
assert(/id="campaignScreen" class="campaign-screen"/.test(html),'campaign screen must be visible before JavaScript runs');
assert(/data-campaign="books">PUSH START/.test(html),'static title must provide PUSH START');
