(function(K){
  ...
  function dungeonsScreen(){
    var story=K.AdventureBooks.story(),unlocked=!!(story&&story.cleared.tutorialDungeon),deeper=!!(story&&story.treasureChest&&story.treasureChest.opened),secondName=deeper?'もっと不思議':'不思議',secondGuide=(deeper?'30F':'27F')+'へ行くと、不思議な宝があるとの噂があるらしい。';
