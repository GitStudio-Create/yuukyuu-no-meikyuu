(function(K){
  ...
  var list=[
    ...
    {id:'wallWraith',name:'壁すべり',role:'trick',floorRange:[21,30],hp:40,attack:17,defense:2,exp:90,behaviorType:'chaser',specialAbility:'wallSprint',spawnWeight:5,maxPerFloor:2,dropRate:.12,dropCategories:['scroll'],color:'#7a8499',iconShape:'ghost',description:'壁の中には入らないが、壁際では素早く移動する。部屋の中央へ誘い出すと戦いやすい。',tier:4},
