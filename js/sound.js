(function(K){
  'use strict';
  var KEY='eternal-labyrinth-se-v1',LEGACY_KEYS=['kiriakari-se-v1'],SE_BASE='BGM/SE/',context=null,enabled=true,volume=.45,unlocked=false,lastPlayed={},history=[],filePools={},poolIndex={};
  var patterns={
