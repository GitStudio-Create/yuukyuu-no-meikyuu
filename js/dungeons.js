...
var modes={
  tutorialDungeon:{id:'tutorialDungeon',name:'ちょっと不思議な悠久の迷宮',maxFloor:10,returnTreasureFloor:10,difficulty:.7,enemyPowerMultiplier:.75,identify:['all'],curseKnown:'all',staffChargesKnown:false,curseRate:0,itemSpawnTable:table('tutorial')},
  normalDungeon:{id:'normalDungeon',name:'不思議な悠久の迷宮',maxFloor:99,returnTreasureFloor:27,difficulty:1,enemyPowerMultiplier:1,identify:['all'],curseKnown:'nonEquipment',staffChargesKnown:false,curseRate:.05,itemSpawnTable:table('normal')},
  mysteryDungeon:{id:'mysteryDungeon',name:'もっと不思議な迷宮',maxFloor:99,returnTreasureFloor:30,difficulty:1.2,enemyPowerMultiplier:1.08,identify:['food','weapon','shield','arrow'],curseKnown:'nonEquipment',staffChargesKnown:false,curseRate:.12,itemSpawnTable:table('mystery')}
};
